package com.jboymercs.endexpansion.entity;
...
import com.jboymercs.endexpansion.entity.ai.EntityAITimedAttack;
import com.jboymercs.endexpansion.entity.ai.EntityFlyMoveHelper;
...
public class EntityController extends EntityModBase implements IAnimatable, IAttack, IAnimationTickable {
    ...
    public void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue((double) MobConfig.guilder_health * getHealthModifierLamented());
        ...
        addEvent(()-> {
            for (int i = 0; i < 40; i += 4) {
                addEvent(() -> {
                    ...
                    float damage = (float) (MobConfig.guilder_attack_damage * getAttackModifierLamented());
